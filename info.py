...
BOT_TOKEN = environ.get('BOT_TOKEN', "5987680291:AAHv859Nv-tciDCy39TsnWfvaNaP_XxR8xM")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001589453955')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://badsha:badshapass@cluster0.8orunbn.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001524622686'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Suport_Badsha_Studios')
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '59a39822088981609b076babedd0c574375aa899')
...
DOWNLOAD_TEXT_URL = "https://t.me/How_Tutorial"

   # Custom Caption Under Button #
CAPTION_BUTTON = "Subscribe"
CAPTION_BUTTON_URL = "https://t.me/Badsha_Studios"
